		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Laporan Kunjungan Usaha",
									"targetURL": "#comzsdlkuzsdxlku-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzsdlkuzsdxlku-display": {
								"semanticObject": "comzsdlkuzsdxlku",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zsdlku.zsdxlku",
									"url": sap.ui.require.toUrl("com/zsdlku/zsdxlku")
								}
							}
						}
					}
